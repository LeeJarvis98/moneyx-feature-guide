...
export function ImageCarousel() {
  const [items, setItems] = useState<CarouselItem[]>([
    { id: 0, pos: 2, url: '/hero_section/carousel/pic1.png' },
    { id: 1, pos: 1, url: '/hero_section/carousel/pic2.png' },
    { id: 2, pos: 0, url: '/hero_section/carousel/pic3.png' },
    { id: 3, pos: 3, url: '/hero_section/carousel/pic4.png' },
