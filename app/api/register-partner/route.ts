...
function buildAgreementEmailHtml(confirmUrl: string): string {
  return `
  <div style="font-family: Arial, sans-serif; max-width: 680px; margin: 0 auto; background: #1a1a1a; color: #fff; padding: 40px; border-radius: 16px;">
    ...
    <div style="margin-bottom: 24px;">
      ...
      <ol style="margin: 0 0 16px; padding-left: 20px; color: #ccc; line-height: 2; font-size: 14px;">
        ...
        <li>Công thức phân chia: <strong style="color: #fff;">5%</strong> cho Tradi &bull; <strong style="color: #fff;">50%</strong> cho người giới thiệu trực tiếp &bull; <strong style="color: #fff;">50%</strong> còn lại chia đều cho upline gián tiếp trong chuỗi.</li>
        <li>Cấp bậc đối tác tăng dần dựa vào tổng khối lượng giao dịch tích lũy của toàn mạng lưới bên dưới.</li>
      </ol>
      <!-- Rank table -->
      <table style="width: 100%; border-collapse: collapse; font-size: 13px;">
        <thead>
          <tr style="background: rgba(255,184,28,0.15);">
            <th style="padding: 10px 12px; text-align: left; color: #FFB81C; border-bottom: 1px solid rgba(255,184,28,0.3);">Cấp Độ</th>
            <th style="padding: 10px 12px; text-align: center; color: #FFB81C; border-bottom: 1px solid rgba(255,184,28,0.3);">Đối Tác</th>
            <th style="padding: 10px 12px; text-align: center; color: #FFB81C; border-bottom: 1px solid rgba(255,184,28,0.3);">Tradi</th>
            <th style="padding: 10px 12px; text-align: center; color: #FFB81C; border-bottom: 1px solid rgba(255,184,28,0.3);">Điều Kiện</th>
          </tr>
        </thead>
        <tbody>
          <tr style="border-bottom: 1px solid rgba(255,255,255,0.05);">
            <td style="padding: 10px 12px; color: #a78bfa;">💎 Kim Cương</td>
            <td style="padding: 10px 12px; text-align: center; color: #fff;">90%</td>
            <td style="padding: 10px 12px; text-align: center; color: #888;">10%</td>
            <td style="padding: 10px 12px; text-align: center; color: #ccc;">2.000 Lot</td>
          </tr>
          <tr style="border-bottom: 1px solid rgba(255,255,255,0.05); background: rgba(255,255,255,0.02);">
            <td style="padding: 10px 12px; color: #e2e8f0;">⭐ Bạch Kim</td>
            <td style="padding: 10px 12px; text-align: center; color: #fff;">85%</td>
            <td style="padding: 10px 12px; text-align: center; color: #888;">15%</td>
            <td style="padding: 10px 12px; text-align: center; color: #ccc;">1.000 Lot</td>
          </tr>
          <tr style="border-bottom: 1px solid rgba(255,255,255,0.05);">
            <td style="padding: 10px 12px; color: #fbbf24;">🏆 Vàng</td>
            <td style="padding: 10px 12px; text-align: center; color: #fff;">80%</td>
            <td style="padding: 10px 12px; text-align: center; color: #888;">20%</td>
            <td style="padding: 10px 12px; text-align: center; color: #ccc;">500 Lot</td>
          </tr>
          <tr style="border-bottom: 1px solid rgba(255,255,255,0.05); background: rgba(255,255,255,0.02);">
            <td style="padding: 10px 12px; color: #94a3b8;">🥈 Bạc</td>
            <td style="padding: 10px 12px; text-align: center; color: #fff;">75%</td>
            <td style="padding: 10px 12px; text-align: center; color: #888;">25%</td>
            <td style="padding: 10px 12px; text-align: center; color: #ccc;">100 Lot</td>
          </tr>
          <tr>
            <td style="padding: 10px 12px; color: #b45309;">🔰 Đồng</td>
            <td style="padding: 10px 12px; text-align: center; color: #fff;">70%</td>
            <td style="padding: 10px 12px; text-align: center; color: #888;">30%</td>
            <td style="padding: 10px 12px; text-align: center; color: #ccc;">Hoàn thành đăng ký</td>
          </tr>
        </tbody>
      </table>
    </div>
