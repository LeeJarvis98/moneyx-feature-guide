...
// Create a context for partner configuration
const PartnerContext = createContext<PartnerConfig | null>(null);

// Hook to use partner configuration in child components
export const usePartnerConfig = () => {
  const context = useContext(PartnerContext);
  return context; // Can be null for main site
};
...
export default function PartnerPageClient({ partnerConfig }: PartnerPageClientProps) {
  ...
  return (
    <PartnerContext.Provider value={partnerConfig}>
